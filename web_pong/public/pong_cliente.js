...
firebase.database().ref("Pong").child("Player1").child("score").on('value', (snap) => { player1.score = parseInt(snap.val());});
firebase.database().ref("Pong").child("Player2").child("score").on('value', (snap) => { player2.score = parseInt(snap.val());});
